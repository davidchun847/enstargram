  ...
  <div class="profileContainer">
    ...
    <div class="profile-right">
          ...
          <c:otherwise>
            <c:choose>
              <c:when test="${profileDto.subscribeState}">
                <button class="cta blue" onclick="toggleSubscribe(${profileDto.user.id}, this)">
                  Unsubscribe
                </button>
              </c:when>
              <c:otherwise>
                <button class="cta" onclick="toggleSubscribe(${profileDto.user.id}, this)">
                  Subscribe
                </button>
              </c:otherwise>
            </c:choose>
      ...
      <div class="subscribe">
        <ul>
          <li>
            <a href="">Posts<span>${profileDto.numPosts}</span> </a>
          </li>
          <li>
            <a href="javascript:openSubscribingModal(${profileDto.user.id});">
    ...
    <div id="tab-1-content" class="tab-content-item show">
      ...
      <div class="tab-1-content-inner">
        ...
        <c:forEach var="post" items="${profileDto.user.posts}">
          <div class="img-box">
            <a href=""> <img src="/img/post/${post.imgUrl}" /> </a>
            <div class="comment">
              <a href="#" class="">
                <i class="fas fa-heart"></i><span>${post.numLikes}</span>
              </a>
            </div>
          </div>
        </c:forEach>
...
<div class="modal-info" onclick="modalInfo()">
  <div class="modal">
    <button onclick="location.href='/user/1/profilemod'">My profile</button>
...
<div class="modal-image" onclick="modalImage()">
  <div class="modal">
    ...
    <button onclick="profileImageUpload(${profileDto.user.id}, ${principal.user.id})">Upload</button>
